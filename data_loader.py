...
def sequence_padding_for_demo(X, tokenizer, max_len):
    input_ids_list = []
    attention_mask_list = []
    pred_mask_list = []
...
if __name__ == '__main__':
    ...
    X = read_text("/home/zhk/TAX_KB/Chinese-NER/data/demo.txt")
    print(type(X))
    print(X)
    input_ids,attention_masks,pred_mask = sequence_padding_for_demo(X,tokenizer,max_len=128)
    print(X[0])

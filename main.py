...
def main(args):
    # labels = ['O', 'B-TaxPayer', 'I-TaxPayer', 'B-Taxobj', 'I-Taxobj', 'B-Tax', 'I-Tax', 'B-Action', 'I-Action']
    # labels = ['O', 'B-Industry', 'I-Industry', 'B-Loc', 'I-Loc', 'B-StartTime', 'I-StartTime', 'B-EndTime', 'I-EndTime',
    #  'B-UpperAmount', 'I-UpperAmount', 'B-LowerAmount', 'I-LowerAmount', 'B-KWordAmount', 'I-KWordAmount', 'B-Buyer', 'I-Buyer', 'B-TaxRate', 'I-TaxRate']
